...
public class ExtCollectionUtilsTest {
	...
	public void testTreeSetSupplier() throws Exception {
		...
		List<Integer> list = new ArrayList<>(ExtCollectionUtils.collection(ExtCollectionUtils.treeSetSupplier(cmp), 1, 2, 2, 5));
	...
	public void testSplit() throws Exception {
		...
		assertEquals(Arrays.asList(
				...
				ExtCollectionUtils.split(list, 5, ArrayList::new));
