...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 */
	public static InputStream getResourceAsStream(final Class<?> clazz, final String resourceName) throws FileNotFoundException {
		InputStream is = null;
		if (clazz != null) {
	 ...
	 * <b>The file extension includes the dot<b>
	 *
	 * @param file
	 *            the file
